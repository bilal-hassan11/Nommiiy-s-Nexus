      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="row align-items-end">
            ...
            <div class="mb-3 col-lg-8 d-flex justify-content-start gap-2">
            ...
            <table class="table table-striped">
              ...
              <tr>
                ...
                <th @click="sortTable('username')">
                  Username <span v-if="sortColumn === 'username'">{{ sortOrder === 'asc' ? '↑' : '↓' }}</span>
                </th>
...
const searchModal = () => {
  console.log('Searching for:', form.value.username);
