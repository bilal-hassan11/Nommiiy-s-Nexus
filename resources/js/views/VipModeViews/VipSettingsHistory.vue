<template>
  ...
  <div class="row align-items-center form-header">
    <div class="col-lg-3 col-md-12 col-sm-12">
      ...
      <p class="breadcrumb">VIP Mode > <strong>VIP Settings History</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="text" v-model="form.actionBy" class="form-control">
      </div>
      <div class="col-md-6 col-lg-3">
        <label>Adjustment Record</label>
        <select v-model="form.adjustmentRecord" class="form-select">
          <option value="All">All</option>
          <option>Record Level 1</option>
          <option>Record Level 2</option>
          <option>Record Level 3</option>
        </select>
      </div>
...
const clearForm = () => {
  form.value.adjustmentRecord = "All";
