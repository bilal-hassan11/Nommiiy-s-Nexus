<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-10 col-md-9 col-sm-12">
      ...
      <p class="breadcrumb">Promotion > <strong>Promotion Code</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="text" v-model="form.promoCode" class="form-control">
      </div>
      <div class="col-md-6 col-lg-3">
      ...
      <div class="col-md-6 col-lg-3">
        <label>Bonus</label>
        <select v-model="form.bonus" class="form-select">
          <option value="" disabled selected hidden>Please Select Bonus</option>
          <option>All</option>
          <option>Bank</option>
          <option>Cash</option>
        </select>
