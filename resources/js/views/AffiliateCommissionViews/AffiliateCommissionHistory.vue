<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-7 col-md-4 col-sm-6">
      ...
      <p class="breadcrumb">Affiliate Comm > <strong>Affiliate Commission History</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    ...
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.commission" class="form-select">
...
const clearForm = () => {
  ...
  form.value.affiliate = "All";
  form.value.affiliateGroup = "";
  form.value.commission = "none";
