<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-12 col-md-12 col-sm-6">
      ...
      <p class="breadcrumb">Rebate > <strong>Provider Rebate History</strong></p>
    </div>
  </div>
  ...
  <div class="form-container mt-3">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-9">
        <div class="row text-secondary" style="font-size: 12px; font-weight: 500; margin: 10px 1px 10px 4px;">
          Date
        </div>
      ...
      <p style="font-size: 10px; font-weight: 500; margin: 10px 1px 10px 4px; color: #d87a00">
        ** Username is required if date range is blank.
      </p>
