  ...
  <div class="form-container mt-3">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.categoryName" class="form-select">
          <option value="All">All</option>
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.releaseMethod" class="form-select">
          <option value="All">All</option>
...
const clearForm = () => {
  ...
  form.value.categoryName = "All";
  form.value.releaseMethod = "All";
