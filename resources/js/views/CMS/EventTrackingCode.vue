<template>
  <MasterTrackerModal v-model="showMasterTrackerModal" @submit="handleFormSubmit"/>
  <EventLogModal v-model="showEventLogModal" @submit="handleFormSubmit"/>

  <div class="row align-items-center form-header">
    <div class="col-lg-7 col-md-4 col-sm-6">
      <h2 class="form-title">CMS</h2>
      <p class="breadcrumb">CMS > <strong>Event Tracking Code</strong></p>
    </div>
    <div class="col-lg-5 col-md-8 col-4 col-sm-12 d-flex justify-content-end gap-2">
      <button class="btn tag-btn d-flex align-items-center justify-content-center"
              @click="showMasterTrackerModal = true">
        Master Tracker
      </button>
      <button class="btn tag-btn d-flex align-items-center justify-content-center"
