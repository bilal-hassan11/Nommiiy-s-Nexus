<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-10 col-md-8 col-sm-12">
      ...
      <p class="breadcrumb">Deposit/Withdraw > <strong>Express Deposit</strong></p>
    </div>
    <div class="col-lg-2 col-md-4 col-sm-6 d-flex align-items-center justify-content-end">
      <button class="btn tag-btn me-2">Name Checking</button>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="text" v-model="form.callbackID" class="form-control">
      </div>

      <div class="col-md-6 col-lg-3">
        <label>Merchant Bank Holder</label>
        <input type="text" v-model="form.merchantBankHolder" class="form-control">
      </div>

      <div class="col-md-6 col-lg-3">
        <label>Merchant Bank Account</label>
        <input type="text" v-model="form.merchantBankAccount" class="form-control">
      </div>

      <div class="col-md-6 col-lg-3">
        <label>Recipient Bank Account</label>
        <input type="text" v-model="form.recipientBankAccount" class="form-control">
      </div>
...
const clearForm = () => {
  ...
  form.value.callbackID = "";
  form.value.merchantBankHolder = "";
  form.value.merchantBankAccount = "";
  form.value.recipientBankAccount = "";
