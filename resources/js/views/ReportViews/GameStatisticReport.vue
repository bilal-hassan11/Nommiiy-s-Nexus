<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <p class="breadcrumb">Report > <strong>Game Statistic Report</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3 align-items-center">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="text" v-model="form.gameName" class="form-control">
      </div>

      <div class="col-md-6 col-lg-3">
        <label>RTP</label>
        <input type="text" v-model="form.rtp" class="form-control">
      </div>
      ...
      <!-- Date Range Column -->
      <div class="col-lg-6 col-md-8 col-sm-12 d-flex flex-column">
