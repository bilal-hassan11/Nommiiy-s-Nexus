<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <p class="breadcrumb">Report > <strong>Company Report</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        <label>Start Date</label><span style="font-size: 10px; font-weight: 500; margin: 10px 1px 10px 4px; color: #ae0404">*60 Valid Days</span>
    ...
    <div class="row gx-2 gy-3 align-items-start">
      ...
      <div class="col-lg-8 col-md-8 col-sm-12 d-flex flex-column">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'Today'}" @click="filterByDateRange('Today')">Today</button>
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'Yesterday'}" @click="filterByDateRange('Yesterday')">Yesterday</button>
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'This Week'}" @click="filterByDateRange('This Week')">This Week</button>
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'Last Week'}" @click="filterByDateRange('Last Week')">Last Week</button>
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'This Month'}" @click="filterByDateRange('This Month')">This Month</button>
          <button class="recent btn btn-light" :class="{'btn-active': activeRange === 'Last Month'}" @click="filterByDateRange('Last Month')">Last Month</button>
        </div>
      </div>

      <!-- Daily Checkbox Column -->
