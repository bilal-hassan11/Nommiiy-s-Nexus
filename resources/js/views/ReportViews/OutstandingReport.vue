<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <p class="breadcrumb">Report > <strong>Outstanding Report</strong></p>
    </div>
  </div>
    ...
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.provider" class="form-select">
          <option value="All">All</option>
          <option>3SINGV2</option>
          <option>3SINGV4</option>
          <option>3SINGV7</option>
        </select>
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        <label>Play ID</label>
        <input type="text" v-model="form.playID" class="form-control">
      </div>
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.betType" class="form-select">
          <option value="All">All</option>
          <option>Bet 1</option>
          <option>Bet 2</option>
          <option>Bet 3</option>
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 d-flex flex-column">
          <label for="dailyCheckbox" style="font-size: 12px; font-weight: 500; margin-bottom: 5px;">Is First
            Half</label>
...
const clearForm = () => {
  ...
  form.value.username = "";
  form.value.sportType = "All";
  form.value.betType = "All";
  form.value.playID = "";
  form.value.merchant = "MJB";
  form.value.provider = "3SINGV2";
