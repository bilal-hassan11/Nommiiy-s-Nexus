<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <p class="breadcrumb">Report > <strong>FTD/STD Report</strong></p>
    </div>
  </div>
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="text" v-model="form.referralUsername" class="form-control">
      </div>
      <div class="col-md-6 col-lg-3">
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <input type="date" v-model="form.registerFrom" class="form-control">
      </div>

      <div class="col-md-6 col-lg-3">
        <label>Register To</label>
        <input type="date" v-model="form.registerTo" class="form-control">
      </div>
      <div class="col-md-6 col-lg-3">
        <label>Account Status</label>
        <select v-model="form.accountStatus" class="form-select">
          <option value="All">All</option>
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.phoneVerificationStatus" class="form-select">
          <option value="All">All</option>
          <option value="Active">Active</option>
          <option value="Inactive">Inactive</option>
        </select>
      ...
      <div class="col-md-6 col-lg-3">
        ...
        <select v-model="form.depositType" class="form-select">
          <option value="first-time-deposit">First Time Deposit</option>
          <option value="Active">Active</option>
          <option value="Inactive">Inactive</option>
        </select>
      </div>
...
const form = ref({
  ...
  parentLogin: "",
  accountStatus: "All",
  phoneVerificationStatus: "All",
  risk: "All",
  source: "",
  depositType: "first-time-deposit",
  createdAt: firstDay,
...
const clearForm = () => {
  ...
  form.value.referralUsername = "";
  form.value.affiliateUsername = "";
  form.value.username = "";
  form.value.accountStatus = "All";
  form.value.phoneVerificationStatus = "All";
  form.value.risk = "All";
  form.value.source = "";
  form.value.depositType = "first-time-deposit";
