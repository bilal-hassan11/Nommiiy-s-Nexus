<template>
  <AddAdvertisementModal v-model="showAddAdvertisementModal" @submit="handleFormSubmit"/>

  <div class="row align-items-center form-header">
    <div class="col-lg-7 col-md-4 col-sm-6">
      <h2 class="form-title">System Settings</h2>
      <p class="breadcrumb">System Settings > <strong>Advertisement</strong></p>
    </div>
    <div class="col-lg-5 col-md-8 col-sm-6 d-flex align-items-center justify-content-end">
      <button class="btn btn-outline-success add-btn d-flex align-items-center me-2"
              @click="showAddAdvertisementModal = true">
  ...
  <div class="form-container">
    <div class="row gx-3 gy-3">
      ...
      <div class="col-md-6 col-lg-3">
        <label>Ad Type</label>
        <select v-model="form.adType" class="form-select">
          <option value="All">All</option>
      ...
      <div class="col-md-6 col-lg-3">
        <label>Ad No</label>
        <input type="text" v-model="form.adNo" class="form-control">
      </div>
      <div class="col-md-6 col-lg-3">
        <label>Ad Title</label>
        <input type="text" v-model="form.adTitle" class="form-control">
      </div>
    </div>
...
import AddAdvertisementModal from "@/views/SystemSettingsViews/modals/AddAdvertisementModal.vue";
