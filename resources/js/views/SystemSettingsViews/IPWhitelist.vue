<template>
  <AddIPWhitelistModal v-model="showAddIPWhitelistModal" @submit="handleFormSubmit"/>

  <div class="row align-items-center form-header">
    <div class="col-lg-7 col-md-4 col-sm-6">
      <h2 class="form-title">System Settings</h2>
      <p class="breadcrumb">System Settings > <strong>IP Whitelist</strong></p>
    </div>
    <div class="col-lg-5 col-md-8 col-sm-6 d-flex align-items-center justify-content-end">
      <button class="btn btn-outline-success add-btn d-flex align-items-center me-2"
              @click="showAddIPWhitelistModal = true">
...
import AddIPWhitelistModal from "@/views/SystemSettingsViews/modals/AddIPWhitelistModal.vue";

const showAddIPWhitelistModal = ref(false);
