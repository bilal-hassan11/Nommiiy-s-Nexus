              ...
              <div class="row">
                <div class="mb-3 col-md-6">
                  ...
                  <select v-model="form.activityType" class="form-select">
                    <option>Lucky Wheel -5</option>
                  </select>
                </div>
                <div class="mb-3 col-md-6">
                  <label class="form-label">Currency</label>
                  <select v-model="form.currency" class="form-select" disabled>
                    <option>BDT</option>
                    <option>NPR</option>
                  </select>
                </div>
                ...
                <table class="table table-striped align-middle text-center">
                  ...
                  <tr v-for="(row, index) in prizeRows" :key="index">
                    <td class="text-start px-3">
                      <div v-if="form.resultOptions === 'real-name-list'">
                        <span v-if="row.prizeText">Actual Prize : {{ row.prizeText }}</span>
                        <span v-else>Fixed Prize: {{ row.prize }} BDT</span>
                      </div>
                      <div v-else>
            ...
            <div v-if="form.resultOptions === 'generate-by-system'">
              ...
              <div class="table-responsive mb-4">
                <table class="table table-striped align-middle text-center">
                  ...
                  <tr v-for="(row, index) in prizeRows" :key="index">
                    <td class="text-start px-3">
                      <div v-if="['real-name-list', 'generate-by-system'].includes(form.resultOptions)">
                        <span v-if="row.prizeText">Actual Prize : {{ row.prizeText }}</span>
                        <span v-else>Fixed Prize: {{ row.prize }} BDT</span>
                      </div>
                      <div v-else>
...
const prizeRows = ref([
  {prize: 1288, rate: 10, prizeText: "Samsung S25 Ultra"},
  {prize: 1288, rate: 10},
  {prize: 28, rate: 10},
  {prize: 68, rate: 10},
  {prize: 128, rate: 10},
  {prize: 100, rate: 10, prizeText: "Activity Points : 100 Point(s)"},
  {prize: 388, rate: 10},
]);
