<template>
  <AddTopReferralModal v-model="showModal" @submit="handleFormSubmit"/>

  <div class="row align-items-center form-header">
    <div class="col-lg-10 col-md-9 col-sm-12">
      <h2 class="form-title">Leaderboard Data</h2>
      <p class="breadcrumb">Leaderboard Data > <strong>Top Referral</strong></p>
    </div>
...
import AddTopReferralModal from "@/views/LeaderboardDataViews/modals/AddTopReferralModal.vue";
