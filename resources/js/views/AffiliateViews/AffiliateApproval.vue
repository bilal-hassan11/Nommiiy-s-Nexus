<template>
  <div class="row align-items-center form-header">
    <div class="col-lg-7 col-md-4 col-sm-6">
      ...
      <p class="breadcrumb">Affiliate > <strong>Affiliate Approval</strong></p>
    </div>
    <div class="col-lg-5 col-md-8 col-sm-6 d-flex align-items-center justify-content-end">
      ...
      @click="affiliateApprovalHistoryPage">
...
function affiliateApprovalHistoryPage(){
  router.push('/affiliate-approval-history');
}
</script>
